...
from utils_Kitti360 import load_poses, load_calib, load_files, load_vertex
...
try:
  ...
  from utils_Kitti360 import range_projection
...
if __name__ == '__main__':
  ...
  # specify parameters
  num_last_n_list = config['num_last_n_list']
  ...
  for num_last_n in num_last_n_list:
    for seq in sequences:
      ...
      calib_file = os.path.join(scan_folder, seq, 'calib_cam_to_velo.txt') # calibration file
      residual_image = 'residual_images_' + str(num_last_n)
      ...
      #  load LiDAR scans
      #scan_folder = config['scan_folder']
      scan_paths = load_files(scan_folder_seq)
